...
TECHNO_IMG = "https://telegra.ph/file/09156f42905a0f645ce62.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/PR1YANSHU")],
                                                                                   [InlineKeyboardButton(text="ADD CARLO BOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/legendx22n/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("ZINDA HOON BHOSDIKE")
